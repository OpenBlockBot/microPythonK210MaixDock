                ...
                blocks: [
                    {
                        opcode: 'setPinMode',
                        text: formatMessage({
                            id: 'microPythonK210MaixDock.pins.setPinMode',
                    ...
                    },
                    {
                        opcode: 'setPwmOutput',
                        text: formatMessage({
                            id: 'microPythonK210MaixDock.pins.setPwmOutput',
                    ...
                    '---',
                    {
                        ...
                        text: formatMessage({
                            id: 'microPythonK210MaixDock.pins.setServoOutput',
                    ...
                    '---',
                    {
                        ...
                        text: formatMessage({
                            id: 'microPythonK210MaixDock.pins.attachInterrupt',
                ...
                blocks: [
                    {
                        opcode: 'serialBegin',
                        text: formatMessage({
                            id: 'microPythonK210MaixDock.serial.serialBegin',
